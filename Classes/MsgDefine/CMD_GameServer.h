...
#define SUB_GR_START_MATCHCLIENT		413							//启动等待界面

//大宏MDM_GF_FRAME
#define SUB_GR_MATCH_SCREEN_FISH			420									//比赛信息
#define SUB_GR_MATCHFISH_INFO			421									//比赛信息
#define SUB_GR_MATCHFISH_NEXT_LEVEL 422
